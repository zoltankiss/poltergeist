Poltergeist.Browser = (function() {
  ...
  Browser.prototype.resetPage = function() {
    ...
    this.page.setViewportSize(this.width, this.height);
  ...
  Browser.prototype.window_size = function(handle) {
    var height, page, width, _ref;
    page = this.getPageByHandle(handle);
    _ref = page.viewportSize(), width = _ref.width, height = _ref.height;
    return this.sendResponse([width, height]);
  };

  Browser.prototype.resize_window_to = function(handle, width, height) {
    var page;
    page = this.getPageByHandle(handle);
